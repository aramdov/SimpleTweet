...
public class TwitterClient extends OAuthBaseClient {
	public static final BaseApi REST_API_INSTANCE = TwitterApi.instance(); // calling twitterapi
	public static final String REST_URL = "https://api.twitter.com/1.1"; // base API URL / Resource URL
	...
	// Authenticate w/ Twitter -> Receive a token -> store token in our app -> make requests on behalf of that user -> instruct twitter to open up intent again later
	...
	public void getHomeTimeline(JsonHttpResponseHandler handler) {
		...
		params.put("count", 25);
		params.put("since_id", 1); // later we modify this for pull down to refresh to grab only recent tweets past some id x
